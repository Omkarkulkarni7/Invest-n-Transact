              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={7}>
                  <Paper elevation={3} sx={{ p: 3, borderRadius: 2, height: "100%" }}>
                    ...
                    {/* Pie Chart Placeholder - This would be replaced by an actual chart component */}
                    <Box sx={{ 
                      height: 300, 
                      display: "flex", 
                      justifyContent: "center", 
                  ...
                  <Table sx={{ minWidth: 650 }}>
                    <TableHead>
                      <TableRow sx={{ backgroundColor: "rgba(0,0,0,0.04)" }}>
                        <TableCell><Typography variant="subtitle2">Stock</Typography></TableCell>
                        ...
                        <TableCell align="right"><Typography variant="subtitle2">Purchase Price</Typography></TableCell>
                        <TableCell align="right"><Typography variant="subtitle2">Current Price</Typography></TableCell>
                        <TableCell align="right"><Typography variant="subtitle2">Market Value</Typography></TableCell>
                        <TableCell align="right"><Typography variant="subtitle2">Profit/Loss</Typography></TableCell>
                        <TableCell align="right"><Typography variant="subtitle2">Change %</Typography></TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {investments.map((investment) => {
                        ...
                        return (
                          <TableRow key={investment.stock_symbol} hover>
                            <TableCell>
                              <Typography variant="body2">{investment.company_name}</Typography>
                            </TableCell>
                            <TableCell>
                              <Chip 
                            ...
                            <TableCell align="right">${investment.purchase_price}</TableCell>
                            <TableCell align="right">${investment.current_price}</TableCell>
                            <TableCell align="right">${marketValue}</TableCell>
                            <TableCell 
                              align="right"
                              sx={{ 
...
const PieChartComponent = ({ data }) => {
  // This is a placeholder that mimics a pie chart
  const colors = [
  ...
  return (
    <svg width="300" height="300" viewBox="0 0 300 300">
      ...
      {/* This would be replaced by actual chart slices */}
      {data.map((item, index) => {
